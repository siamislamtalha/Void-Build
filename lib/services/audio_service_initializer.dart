...
///
/// ## Why configure() is called HERE (not in VoidMusicPlayer's constructor)
///
...
/// the session is fully configured before any VoidMusicPlayer method can run.
...
/// Singleton that creates and owns the [VoidMusicPlayer] instance.
///
...
class PlayerInitializer {
  ...
  Future<VoidMusicPlayer>? _initFuture;

  Future<VoidMusicPlayer> getVoidMusicPlayer() async {
  ...
  Future<VoidMusicPlayer> _initializeInternal() async {
    final player = await AudioService.init(
      builder: () => VoidMusicPlayer(),
      config: const AudioServiceConfig(
        androidNotificationChannelId: 'com.VoidMusicPlayer.notification.status',
